...
def seller_window(ID,Address,Phone,Name,email,seller_win,server):
    ...
    def manage_profits():
        ...
        def Refresh():
            ...
            try:
                ...
                for sale in sales:
                    counter += 1
                    get_buyer_name = cursor.execute("SELECT buyer_name FROM Buyers WHERE buyer_ID = ?",(sale[0])).fetchone()
                    get_product_name = cursor.execute("SELECT product_NAME FROM MARKET WHERE product_ID = ?",(sale[1])).fetchone()
        ...
        MAR_LABEL = Label(profits, text = "ITEMS CURRENTLY IN MARKET", font=('Times New Roman', 30, 'bold'), fg='ghost white', bg = "#1f1f1f")
        ...
        PRO_LABEL = Label(profits, text="SALES RECORD", font=('Times New Roman', 30, 'bold'),fg='ghost white', bg="#1f1f1f")
        ...
        LogoLabel = Label(profits, text="SHOP", font=('Times New Roman', 30, 'bold'), bg='gray1', fg='ghost white',pady=5, padx=5)
        LogoLabel.place(x=7, y=6)

        Back = Button(profits, text="BACK", font=('Times New Roman', 20, 'bold'), bg='gray46', fg='ghost white', pady=5,padx=5, relief=RAISED, bd=5)
        ...
        INFO2 = Label(profits, bg="#374151", text="This is a detailed page of your profits", font=('Arial', 20), fg="ghost white")
        ...
        Item_label = Label(profits, text='Total amount of\nItems sold:', font=('Arial', 20, 'bold'), fg="gray1", bg="ghost white")
        ...
        prof_label = Label(profits, text='Total profit gained\nfrom sales:', font=('Arial', 20,'bold'), fg="gray1",bg="ghost white")
        ...
        notif_prof = Label(profits, text='has been obtained from sales', font=('Arial', 15), fg="gray1", bg="ghost white")
        ...
        REFRESH = Button(profits, text = "REFRESH PROFITS", font=('Arial', 20,'bold'), relief=RAISED, bd = 5, bg = "green", fg = "ghost white")
    ...
    welcome3 = Label(seller_main, text = f"Seller\n{Name}", font=('Times New Roman', 40), fg = "gray1",bg = "#E5E7EB")
    welcome3.place(x=230, y=200)

    INFO1 = Label(seller_main, text ="Thank you for being part of\nour selling community", font=('Times New Roman', 25), fg = "gray1",bg = "#E5E7EB")
    INFO1.place(x = 110, y = 350)

    INFO2 = Label(seller_main, text="This is the main menu,\nnavigate through the\n selection on the side to\n get started", font=('Times New Roman', 25),
                  fg="gray1", bg="#E5E7EB")
    ...
    MAINLABEL = Label(seller_main, text="MAIN MENU", font=('Times New Roman', 40, 'bold'), bg='#3A3A3A',pady=5, padx=5, fg = 'ghost white')
    ...
    BUT1 = Button(seller_main,text= 'MY ACCOUNT', font = ('Times New Roman',30,'bold'),bg = '#475569', fg = 'ghost white', relief=RAISED, bd = 5)
    BUT1.config(activebackground="SlateBlue3")
    BUT1.config(command=manage_account)
    BUT1.place(x = 800 , y = 190, height = 70, width = 420)

    BUT2 = Button(seller_main, text='CHECK INVENTORY', font=('Times New Roman', 30, 'bold'), bg='#475569',fg='ghost white', relief=RAISED, bd=5)
    BUT2.config(activebackground="SlateBlue3")
    BUT2.config(command=check_inv)
    BUT2.place(x=800, y=290, height=70, width=420)

    BUT3 = Button(seller_main, text='MANAGE PROFITS', font=('Times New Roman', 30, 'bold'), bg='#475569',fg='ghost white', relief=RAISED, bd=5)
    BUT3.config(activebackground="SlateBlue3")
    BUT3.config(command = manage_profits)
    BUT3.place(x=800, y=390, height=70, width=420)

    BUT4 = Button(seller_main, text='MANAGE MARKET', font=('Times New Roman', 30, 'bold'), bg='#475569',fg='ghost white', relief=RAISED, bd=5)
...
def buyer_window(ID, Address, Phone, Name, email, buyer_win,server):
    def CHECK_OUT(CART_ID,QUANTITY,COST,NAME,CCART):
        ...
        def PAY():
            ...
            payment_status = ''
            if mode_payment == "CASH ON DELIVERY":
            ...
            try:
                ...
                cursor.execute(query_stmt4,(int(ID),Address,Phone,int(seller_id),sel_add,sel_number,int(product_id),int(QUANTITY),int(Bill_ID),mode_payment,payment_status,int(COST)))
                cursor.commit()
                ...
                #loading screeen
                messagebox.showinfo(title="payment notice",message="PAYMENT PROCESSING SUCCESSFULY please wait for your product to deliver")
        ...
        E_PAYMENT = ttk.Combobox(Billing, textvariable=payment, state="readonly")
        ...
        E_PAYMENT['values'] = ("G-CASH", "PAY MAYA", "7-ELEVEN", 'BDO', "CASH ON DELIVERY", "BPI",)
        E_PAYMENT.current(0)

        payment.set(E_PAYMENT.get())
    ...
    def CHECK_CART():
        ...
        BUT1 = Button(CCART, text = 'CHECK OUT\n ITEM',bg = 'green', font=("Helvetica", 15, "bold"), fg = "ghost white", relief=RAISED, bd = 5)
        BUT1.place(x = 980, y = 600, width = 180)
        BUT1.config(command = GET_ID)

        BUT2 = Button(CCART, text='REMOVE FROM\n CART', bg='red', font=("Helvetica", 15, "bold"), fg="ghost white",relief=RAISED, bd=5)
